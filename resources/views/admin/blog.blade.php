        ...
        <div class="main-title-sec">
            <div class="row">
                ...
                <div class="col-md-9 column">
                    ...
                    <div class="quick-btn-title"> <a href="{{url('addBlog')}}" title=""><i class="fa fa-plus"></i> New Blog</a></div>
                </div>
            </div>
        </div>
        <!-- Heading Sec -->
                    ...
                    <div class="blog-sec">
                        <div class="row" id="dylay">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="blog-post">
                                    <div class="blog-post-thumb" style="height: 300px;width: 300px"> <img src="{{asset('uploads/product/'.$blog->image)}}" alt="" /> <a href="#" title=""><i class="fa fa-paperclip"></i></a> </div>
                                    ...
                                    <a href="{{url('editBlog',$blog->id)}}"><button class="btn btn-info">Edit{{$blog->id}}</button></a>
                                </div>
                            </div>
                            @endforeach
                            <div class="col-md-12">
