...
<head>
    ...
    <title>lifestyle - Trending News Updates</title>
    ...
    <script type='text/javascript' src='//pl17319982.safestgatetocontent.com/bb/9a/e1/bb9ae1b78130bdc522f9b08119eddd6d.js'></script>
        ...
        <div class="row align-items-center justify-content-center d-flex">
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li style="background-color:red"><a href="{{url('lifestyle')}}">Lifestyle</a></li>
