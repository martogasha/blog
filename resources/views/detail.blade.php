    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-8">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <img src="{{asset('images/xcrypto-news-2-600x450.jpg.pagespeed.ic.q1-X1JFeJ3.jpg')}}" alt="">
                    ...
                    <div class="col-sm-6">
                        <img src="{{asset('images/xcrypto-news-1-600x450.jpg.pagespeed.ic.qWKdAjrTgE.jpg')}}" alt="">
