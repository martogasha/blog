    ...
    <div class="h-600x h-sm-auto">
        <div class="h-2-3 h-sm-auto oflow-hidden">
            <div class="pb-5 pr-5 pr-sm-0 float-left float-sm-none w-2-3 w-sm-100 h-100 h-sm-300x">
                <a class="pos-relative h-100 dplay-block" href="{{url('blog',['id'=>$one->id,'name'=>$one->category,'category'=>$one->title])}}">
            ...
            <div class="float-left float-sm-none w-1-3 w-sm-100 h-100 h-sm-600x">
                ...
                <div class="pl-5 pb-5 pl-sm-0 ptb-sm-5 pos-relative h-50">
                    <a class="pos-relative h-100 dplay-block" href="{{url('blog',['id'=>$two->id,'name'=>$two->category,'category'=>$two->title])}}">
        ...
        <div class="h-1-3 oflow-hidden">
            ...
            <div class="pr-5 pr-sm-0 pt-5 float-left float-sm-none pos-relative w-1-3 w-sm-100 h-100 h-sm-300x">
                <a class="pos-relative h-100 dplay-block" href="{{url('blog',['id'=>$three->id,'name'=>$three->category,'category'=>$three->title])}}">
            ...
            <div class="col-md-12 col-lg-8">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <h4 class="pt-20"><a href="{{url('blog',['id'=>$four->id,'name'=>$four->category,'category'=>$four->title])}}"><b>{{\Illuminate\Support\Str::of($four->title)->words(7)}}</b></a></h4>
                        <ul class="list-li-mr-20 pt-10 pb-20">
                            <li class="color-lite-black"><a href="{{url('blog',['id'=>$four->id,'name'=>$four->category,'category'=>$four->title])}}" class="color-black"><b>{{$four->category}}</b></a></li>
                            <li><i class="color-primary mr-5 font-12 ion-ios-time"></i><b>{{$four->created_at->diffForHumans()}}</b></li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        @foreach($fives as $five)
                        <a class="oflow-hidden pos-relative mb-20 dplay-block" href="{{url('blog',['id'=>$five->id,'name'=>$five->category,'category'=>$five->title])}}">
                ...
                <div class="row">
                    @foreach($sevens as $seven)
                        <div class="col-sm-6">
                            ...
                            <h4 class="pt-20"><a href="{{url('blog',['id'=>$seven->id,'name'=>$seven->category,'category'=>$seven->title])}}"><b>{{\Illuminate\Support\Str::of($seven->title)->words(7)}}</b></a></h4>
                            <ul class="list-li-mr-20 pt-10 pb-20">
